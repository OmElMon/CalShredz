 ...
 * 
 * These are direct re-exports of the base Radix UI components with no customization.
 */
 ...
 * 
 * The button that users click to open the select dropdown.
 * 
 * @param className - Additional CSS classes
 * @param children - Content inside the trigger (usually the selected value)
 * @param props - Other props passed to the component
 ...
 * 
 * @param className - Additional CSS classes
 * @param children - Content (usually SelectItems)
 * @param position - Positioning strategy ("popper" by default)
 * @param props - Other props passed to the component
 * @param ref - Forwarded ref
 */
  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={cn(
        ...
        // Additional positioning styles when using the "popper" position
        position === "popper" &&
 ...
 * 
 * An individual option that can be selected from the dropdown.
 * 
 * @param className - Additional CSS classes
 ...
 * 
 * A visual divider line to separate groups of items in the dropdown.
 * 
 * @param className - Additional CSS classes
 * @param props - Other props passed to the component
 * @param ref - Forwarded ref
